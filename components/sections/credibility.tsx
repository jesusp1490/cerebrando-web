...
export function Credibility() {
  ...
  const testimonials = [
    {
      ...
      content:
        "Próximamente verás aquí historias reales de transformación...",
      rating: 5,
    ...
    },
    {
      ...
      content:
        "Testimonios de personas que han cambiado su vida con Cerebrando...",
      rating: 5,
    ...
    },
    {
      ...
      content:
        "Experiencias reales de mejora en sueño, estrés y bienestar...",
      rating: 5,
  ...
  return (
    <section
      id="credibilidad"
      className="relative py-14 sm:py-16 md:py-20 lg:py-28 xl:py-32 bg-neutral-dark/8"
    >
      {/* Top Wave */}
      <div className="absolute top-0 left-0 right-0 h-40 -mt-1">
        ...
        >
          <path
            ...
            fill="rgb(199, 214, 217)"
          />

          <path
            d="M0,0 L0,50 Q360,110 720,50 T1440,50 L1440,0 Z"
            fill="rgb(199, 214, 217)"
            opacity="0.7"
          />
        </svg>
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          >
            ...
            >
              Experiencia profesional de la Dra. Ángela de Abreu
            </h2>
          </motion.div>
          ...
          >
            <p className="text-sm sm:text-base md:text-lg lg:text-xl text-muted-foreground leading-relaxed max-w-4xl mx-auto text-pretty">
              Soy la Dra. Ángela de Abreu, especialista en
              Neurofisiología Clínica. He trabajado en hospitales
              líderes como HM Hospitales en Madrid y Málaga, y soy
              colaboradora científica de la Sociedad Española de
              Neurofisiología Clínica.
            </p>

            <p className="text-sm sm:text-base md:text-lg lg:text-xl text-muted-foreground leading-relaxed max-w-4xl mx-auto text-pretty">
              Mi trabajo combina más de una década de experiencia
              médica con los avances de la neurociencia aplicada al
              bienestar. Esta experiencia es también la base de
              Cerebrando, un proyecto creado para acercar la
              neurociencia al día a día.
            </p>
          </motion.div>
              ...
              return (
                <motion.div
                  ...
                  style={{
                    ...
                    boxShadow:
                      "0 4px 16px rgba(199, 214, 217, 0.2), 0 2px 8px rgba(188, 120, 46, 0.15)",
                  }}
                >
          ...
          >
            <div className="inline-flex items-center px-5 sm:px-6 py-2 sm:py-3 rounded-full bg-brand-primary/15 border-2 border-brand-primary/30 shadow-lg">
              <span className="text-sm sm:text-base md:text-lg font-medium text-brand-primary">
                👉 Aquí encontrarás historias y experiencias de
                pacientes y alumnas de Cerebrando.
              </span>
            </div>
          </motion.div>
          ...
          >
            <div className="text-center">
              ...
              <p className="text-base sm:text-lg text-muted-foreground">
                Experiencias de la comunidad Cerebrando
              </p>
            </div>
            ...
            <div className="relative max-w-4xl mx-auto">
                      ...
                      <div className="w-24 h-24 rounded-full bg-gradient-to-br from-brand-primary/30 to-brand-accent/30 p-1 shadow-xl">
                        <div className="w-full h-full rounded-full overflow-hidden bg-white">
                          <Image
                            ...
                            alt={`Testimonio de ${testimonials[currentTestimonial].name} sobre Cerebrando`}
                            width={96}
                            height={96}
              ...
              <div className="flex justify-center space-x-4 mt-8">
                <Button
                  ...
                  style={{
                    borderColor: "rgba(199, 214, 217, 0.3)",
                  }}
                >
